...
latex_documents = [
    (master_doc, "splinart.tex", "splinart Documentation", "Loic Gouarin", "manual"),
]
...
man_pages = [(master_doc, "splinart", "splinart Documentation", [author], 1)]
